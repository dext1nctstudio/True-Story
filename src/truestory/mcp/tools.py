...
_Q_CLAIM = (
    ...
    "If this claim concerns a countable, structured fact -- who the subject "
    "competed against, appeared with, was employed by, or was present at -- "
    "reconstruct that fact directly from the primary record before consulting "
    "commentary about the claim itself: official results, registers, "
    "competition databases, government records, or contemporaneous documents "
    "of the specific event. Name the specific record found (a game, a filing, "
    "an entry), not a summary of one. A news article reporting that a claim was "
    "disputed or litigated is not the primary record of the underlying fact, "
    "even when it reaches the correct conclusion, and citing it in place of the "
    "record it is reporting on is not itself verification. Use such reporting "
    "only as corroboration once a primary record has been found, or as a last "
    "resort when no primary record exists at all -- and say plainly that no "
    "primary record was found rather than presenting the reporting as if it "
    "were one.\n\n"
    ...
    "it for the period stated rather than for the subject's whole life. Every "
    "fact returned must carry the specific URL it came from, never a "
    "placeholder or an unlisted source. Also establish whether the subject is "
    "living and whether they are a public figure, a limited purpose public "
